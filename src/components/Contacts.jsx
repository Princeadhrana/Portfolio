    ...
    <section className="min-h-screen flex flex-col justify-center px-4 md:px-10" id="contact">
        ...
        <div className="flex space-x-6 mt-8">
            {CONTACT_CONTENT.socialLinks.map((link, index) => {
              const Icon = link.icon === "RiTwitterXFill" ? RiTwitterFill : link.icon === "RiGithubFill" ? RiGithubFill : RiLinkedinFill;
              return (
        ...
        <motion.p className="text-sm text-stone-400 mt-36" initial="hidden" whileInView="visible" custom={1.6} variants={textVariants} >
